...
public final class CarDatabase_Impl extends CarDatabase {
  private volatile ICarDao _iCarDao;
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `cars` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `maker` TEXT, `model` TEXT, `year` INTEGER NOT NULL, `color` TEXT, `seats` INTEGER NOT NULL, `price` REAL NOT NULL)");
        _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '0c8c0ae403ce527b1b1052b3e6d391ee')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        ...
        _columnsCars.put("maker", new TableInfo.Column("maker", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsCars.put("model", new TableInfo.Column("model", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (! _infoCars.equals(_existingCars)) {
          return new RoomOpenHelper.ValidationResult(false, "cars(com.shesha.mobiledevworkshop.roomdatabaseapp.provider.Car).\n"
                  + " Expected:\n" + _infoCars + "\n"
                  + " Found:\n" + _existingCars);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "0c8c0ae403ce527b1b1052b3e6d391ee", "c1cf830cc1f9fa084b128105f795869f");
  ...
  protected Map<Class<?>, List<Class<?>>> getRequiredTypeConverters() {
    ...
    _typeConvertersMap.put(ICarDao.class, ICarDao_Impl.getRequiredConverters());
  ...
  @Override
  public ICarDao customerDao() {
    if (_iCarDao != null) {
      return _iCarDao;
    } else {
      synchronized(this) {
        if(_iCarDao == null) {
          _iCarDao = new ICarDao_Impl(this);
        }
        return _iCarDao;
      }
    }
